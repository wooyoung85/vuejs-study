...
- 현재 가장 주목받고 있는 Frontend Framework 중 하나  
  <img src="./images/lecture_1/1-1.png" width="600px">
...
<img src="./images/lecture_1/1-2.png" width="1000px">
...
<img src="./images/lecture_1/1-3.png" width="1000px">
...
<img src="./images/lecture_1/2-1.png" width="450">
...
---
## Sigle Page Application VS Multiple Page Application

|SPA|MPA|
|-|-|
|<img src="./images/lecture_1/ClientSideRouting.jpg" width="500">|<img src="./images/lecture_1/ServerSideRouting.jpg" width="500">|
---
...
- 필요 기술 스택
  ...
  <img src="./images/lecture_1/2-2.png" width="350">
...
|-|-|
|<img src="./images/lecture_1/2-3.png" width="500">|<img src="./images/lecture_1/2-4.gif" width="500">|

---

### Virtual DOM (React)

<img src="./images/lecture_1/2-5.png" width="700">

<sup>이미지 출처 : [React and the Virtual DOM](https://www.youtube.com/watch?v=BYbgopx44vo)</sup>
...
<sup>출처 : [Rendering Speed & Performance challenge with Famous Front-End Framework](https://medium.com/thothzocial-engineering/rendering-speed-performance-challenge-with-famous-front-end-framework-196c876a68af)</sup>
...
<img src="./images/lecture_1/3-1.png" width="1000">
...
### (일반적인) 브라우저의 Workflow
<img src="./images/lecture_1/5.png" width="1000">

<sup>이미지 출처 : [ReactJS의 Virtual DOM과 Repaint, Reflow](http://blog.drakejin.me/React-VirtualDOM-And-Repaint-Reflow/)</sup>
...
<img src="./images/lecture_1/6.png" width="650">

<sup>이미지 출처: [Virtual Dom](https://medium.com/naukri-engineering/naukriengineering-virtual-dom-fa8019c626b)</sup>

- Virtual DOM은 실제 브라우저에 렌더링 하지 않고 메모리 상에만 존재하는 개념이므로 연산 비용이 매우 적음
- Real DOM 대신 DOM 트리의 변화를 체크하고 **모든 변화를 하나로 묶어서 던져주면 연산의 횟수를 줄일 수 있음**  (<del>연산의 규모는 커질 수 있지만</del>)
...
<img src="./images/lecture_1/7.png" width="500">
...
6.9.0
```
> Mac OS 사용시 명령어 앞에 `sudo`를 꼭 붙여야 함.  
> 안 붙이면 permission denied 에러 발생
...
- Vue.js 개발 관련 플러그인  
  <img src="./images/lecture_1/8.png" width="600">
...
- 선언적으로 HTML DOM에 데이터를 렌더링 하기 위해 콧수염 표현식 사용
  <img src="./images/lecture_1/10.png" width="900">
